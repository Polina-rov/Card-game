...
import image from "./static/celebration.png";
import badImage from "./static/Image.png";
...
export function renderGameBoard(cardsForGame) {
    const body = document.querySelector("body");
    if (!body) {
        return;
    }
...
function enumeration(cards, lengthArr) {
